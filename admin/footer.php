<div class="row">
			<div class="col-md-12">
				<center>Copyright &copy <?php echo date ('Y');?> Website Wisata Kota Medan, design with <span class="glyphicon glyphicon-star-empty"></span> by Ade Lailatul Ramadhani<br/>
